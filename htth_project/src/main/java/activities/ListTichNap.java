...
public class ListTichNap {
    ...
    static {
        ...
        t = new ListTichNap();
        t.num = 500_000;
        t.cat = new byte[]{105, 105, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 7, 4, 4};
        t.id = new short[]{118, 116, 160, 226, 159, 349, 367, 457, 455, 1004, 327, 325, 10, 414, 323}; // 160: Trái sét
        ...
        t.quant = new short[]{1, 1, 150, 200, 200, 5, 10, 20, 100, 20, 6, 200};
        ENTRY.add(t);
        ...
        t.quant = new short[]{2, 1, 10, 5, 2000, 250, 300, 30, 10, 200, 200};
        ENTRY.add(t);
        ...
        t.quant = new short[]{3, 1, 30, 20, 20, 3000, 300, 500, 50, 20, 500, 300};
        ENTRY.add(t);
    }
