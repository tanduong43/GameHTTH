...
public class Buff {
    public static void process(Player p, Message m2) throws IOException {
        ...
        if (time_buff <= 0 && (sk_info.temp.indexSkillInServer == 912 || sk_info.temp.indexSkillInServer == 916 || sk_info.temp.indexSkillInServer == 920)) {
            time_buff = 25000;
        }
        ...
        if (time_buff > 0 && cat == 0 && size == 1) {
            ...
            if (sk_info.temp.indexSkillInServer == 900) {
                ...
                int healHp = (int) ((long) p.body.get_hp_max(true) * 30 / 100);
                Service.use_potion(p, 0, healHp);
            } else if (sk_info.temp.indexSkillInServer == 920) {
                Service.send_eff_haki(p, (short) 920, time_buff); // Thức Tỉnh Nika (eff 920)
                int healHp = (int) ((long) p.body.get_hp_max(true) * 25 / 100);
                Service.use_potion(p, 0, healHp);
            }
            ...
            // Ghi đè trực tiếp đúng effId (21/18/26/912/916/920) để đảm bảo người bấm
            ...
            if (sk_info.temp.indexSkillInServer == 900) {
                ...
                effSkillToSend = 920; // Thức Tỉnh Nika
            }
