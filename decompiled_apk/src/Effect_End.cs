...
public class Effect_End : MainEffect
{
		...
		try
		{
			...
			case 6:
				if (typeSub == 3)
				{
					for (int num29 = 0; num29 < VecEff.size(); num29++)
					{
						...
						fraImgSub2Eff.drawFrameNew(indexEff_1 * fraImgEff.maxNumFrame + point26.f % fraImgEff.maxNumFrame, point26.x / 100, point26.y / 100, 0, 3, g);
					}
				}
			...
			case 11:
			{
				for (int num53 = 0; num53 < VecEff.size(); num53++)
				{
					...
					point43.fraImgEff.drawFrame(point43.f / numNextFrame % point43.fraImgEff.nFrame, point43.x, point43.y, 0, 3, g);
				}
				break;
			}
			case 47:
			{
				for (int num55 = 0; num55 < VecEff.size(); num55++)
				{
					...
					fraImgEff.drawFrame(point45.f / numNextFrame % fraImgEff.nFrame, point45.x, point45.y, 0, 3, g);
				}
				break;
			}
			case 13:
			...
			case 21:
			{
				...
				{
					Point point31 = (Point)VecEff.elementAt(num36);
			...
			case 22:
			{
				...
				{
					Point point16 = (Point)VecEff.elementAt(num10);
					fraImgSubEff.drawFrame(point16.f / numNextFrame % fraImgSubEff.nFrame, point16.x, point16.y, Dir, 3, g);
				}
				if (isUpdateNormal)
				{
					fraImgEff.drawFrame(f / numNextFrame % fraImgEff.nFrame, x, y, Dir, 3, g);
			...
			case 23:
			{
				...
				for (int k = 0; k < VecEff.size(); k++)
				{
					...
					fraImgSubEff.drawFrame(point3.f / numNextFrame % fraImgSubEff.nFrame, point3.x, point3.y, Dir, 3, g);
				}
				break;
			}
			case 26:
			...
			case 27:
				if (f <= fRemove)
				{
					...
					fraImgEff.drawFrame(num7, x, y, Dir, 3, g);
				}
				if (typeSub == 2)
				{
					for (int num8 = 0; num8 < VecEff.size(); num8++)
					{
						...
						fraImgSubEff.drawFrame(point14.f % fraImgSubEff.nFrame, point14.x, point14.y, Dir, 3, g);
					}
				}
				break;
			case 29:
			{
				...
				for (int num44 = 0; num44 < VecEff.size(); num44++)
				{
					...
					fraImgSub2Eff.drawFrame(point35.f % fraImgSub2Eff.nFrame, point35.x, point35.y, Dir, 3, g);
				}
				break;
			}
			case 30:
			{
				...
				{
					Line line = (Line)VecEff.elementAt(num43);
					if (line != null)
					{
						int color = 0;
						if (num43 / 2 < colorpaint.Length)
						{
							color = colorpaint[num43 / 2];
						}
						g.setColor(color);
			...
			case 25:
				...
				if (typeSub == 2)
				{
					for (int num22 = 0; num22 < VecEff.size(); num22++)
					{
						...
						fraImgSub2Eff.drawFrame(point21.f % fraImgSub2Eff.nFrame, point21.x, point21.y, Dir, 3, g);
					}
				}
				break;
			case 35:
			...
			case 37:
			{
				for (int num64 = 0; num64 < VecEff.size(); num64++)
				{
					...
					fraImgSub2Eff.drawFrame(point52.f % fraImgSub2Eff.nFrame, point52.x, point52.y, Dir, 3, g);
				}
				if (f >= 0 && f < 6)
				{
					fraImgEff.drawFrame(f / 2, x1000, y1000, Dir, 3, g);
				...
				if (f < fRemove && f > 1)
				{
					...
					fraImgSubEff.drawFrame(num65, x, y, Dir, 3, g);
				}
				break;
			}
			case 38:
			...
			case 138:
			{
				for (int num51 = 0; num51 < VecEff.size(); num51++)
				{
					...
					fraImgEff.drawFrameNew(point41.frame * 4 + point41.f % fraImgEff.nFrame, point41.x, point41.y, Dir, 3, g);
				}
				break;
			}
			case 39:
			...
			case 168:
			{
				...
				for (int j = 0; j < VecEff.size(); j++)
				{
					...
					if (point2.frame < 2)
					{
						fraImgSubEff.drawFrameNew(point2.fSmall * fraImgSubEff.maxNumFrame + point2.f / 2 % fraImgSubEff.maxNumFrame, point2.x, point2.y, 0, 3, g);
					}
					else
					{
						fraImgSub2Eff.drawFrameNew(point2.fSmall * fraImgSub2Eff.maxNumFrame + point2.f / 2 % fraImgSub2Eff.maxNumFrame, point2.x, point2.y, 0, 3, g);
					}
				}
				break;
			}
			...
			case 50:
			{
				...
				for (int num59 = 0; num59 < VecEff.size(); num59++)
				{
					...
					if (point48.frame < 2)
					{
						fraImgSubEff.drawFrame(point48.f / 2 % fraImgSubEff.nFrame, point48.x, point48.y, 0, 3, g);
					}
					else
					{
						fraImgSub2Eff.drawFrame(point48.f / 2 % fraImgSubEff.nFrame, point48.x, point48.y, 0, 3, g);
					}
				}
				break;
			}
			...
			case 54:
			{
				for (int num45 = 0; num45 < VecEff.size(); num45++)
				{
					...
					{
						fraImgEff.drawFrameNew((2 + num45 % 2) * fraImgEff.maxNumFrame + point36.f % fraImgEff.maxNumFrame, point36.x, point36.y, Dir, 3, g);
					}
					else if (typeSub == 9)
					{
						fraImgEff.drawFrameNew((frame + num45 % 2) * fraImgEff.maxNumFrame + point36.f % fraImgEff.maxNumFrame, point36.x, point36.y, Dir, 3, g);
					}
					else
					{
				...
				if (fraImgSubEff != null)
				{
					...
					{
						Point point37 = (Point)vecSubEff.elementAt(num46);
			...
			case 107:
			{
				...
				{
					Point point34 = (Point)VecEff.elementAt(num41);
			...
			case 110:
			{
				...
				{
					Point point32 = (Point)VecEff.elementAt(num38);
			...
			case 108:
			{
				...
				{
					Point point30 = (Point)VecEff.elementAt(num35);
					if (point30.dis != 0)
					{
			...
			case 66:
			{
				...
				fraImgEff.drawFrameNew(typeSub * 3 + num20, x, y, Dir, 3, g);
				break;
			}
			case 63:
				paintNo_Dat_New(g);
			...
			case 70:
			{
				...
				{
					Point point15 = (Point)VecEff.elementAt(num9);
					fraImgEff.drawFrame(point15.frame, objTo.x, objTo.y + point15.y, Dir, 33, g);
				}
				break;
			}
			case 83:
			...
			case 78:
			{
				for (int num60 = 0; num60 < VecEff.size(); num60++)
				{
					...
					if (point49.frame == 0)
					{
						fraImgSubEff.drawFrame(point49.f % fraImgSubEff.nFrame, point49.x, point49.y, 0, 3, g);
					}
					else
					{
						fraImgSub2Eff.drawFrame(point49.f % fraImgSub2Eff.nFrame, point49.x, point49.y, 0, 3, g);
					}
				}
				int num61 = (int)(10.0 / (1.0 + (double)(GameCanvas.percent + GameCanvas.hardcodeSpeedUp) / 100.0));
				if (num61 <= 0)
				{
					num61 = 1;
				}
			...
			case 76:
			{
				for (int num58 = 0; num58 < VecEff.size(); num58++)
				{
					...
					if (point47.frame == 0)
					{
						fraImgEff.drawFrame(point47.f % fraImgEff.nFrame, point47.x, point47.y, 0, 3, g);
					}
					else
					{
						fraImgSubEff.drawFrame(point47.f % fraImgSubEff.nFrame, point47.x, point47.y, 0, 3, g);
					}
				}
				break;
			}
			...
			case 17:
			{
				...
				fraImgEff.drawFrame(num33, x, y, 0, 3, g);
				break;
			}
			case 31:
			{
				for (int num34 = 0; num34 < VecEff.size(); num34++)
				{
					...
					if (point29.dis == 1)
					{
						fraImgEff.drawFrameNew(point29.f / 2 % fraImgEff.nFrame, point29.x, point29.y, 0, 33, g);
					}
			...
			case 32:
			{
				...
				{
					Point point28 = (Point)VecEff.elementAt(num31);
					if (fraImgEff.nFrame != 0)
					{
						if (point28.dis == 1)
						{
							fraImgEff.drawFrameNew(fraImgEff.nFrame - point28.f / 2 % fraImgEff.nFrame, point28.x, point28.y, 0, 33, g);
						}
						else if (point28.dis == 0)
						{
							fraImgSubEff.drawFrameNew((point28.frame + point28.f / 2) % fraImgSubEff.nFrame, point28.x, point28.y, 0, 3, g);
						}
					}
				}
				break;
			...
			case 7:
			{
				...
				{
					Point_Focus point_Focus2 = (Point_Focus)VecEff.elementAt(num28);
			...
			case 96:
			{
				...
				{
					Point_Focus point_Focus = (Point_Focus)VecEff.elementAt(num12);
			...
			case 98:
			{
				...
				for (int num3 = 0; num3 < VecEff.size(); num3++)
				{
					...
					fraImgSubEff.drawFrame(point10.f % 5, point10.x, point10.y, 0, 3, g);
				}
				break;
			}
			case 99:
			{
				...
				for (int num2 = 0; num2 < VecEff.size(); num2++)
				{
					...
					fraImgSub2Eff.drawFrame(point9.f % 5, point9.x, point9.y, 0, 3, g);
				}
				break;
			}
			case 172:
			...
			case 104:
			{
				for (int num63 = 0; num63 < VecEff.size(); num63++)
				{
					...
					fraImgEff.drawFrame(point51.f, MainScreen.cameraMain.xCam + point51.x, point51.y, 0, 3, g);
				}
				break;
			}
			case 105:
			...
			case 111:
			{
				...
				{
					fraImgEff.drawFrame(0, x, y - num56 * fraImgEff.frameHeight + 5, CRes.random(2) * 2, 33, g);
				}
				...
				for (int num57 = 0; num57 < VecEff.size(); num57++)
				{
					...
					fraImgSubEff.drawFrameNew(point46.frame, x + point46.x, y + point46.y, Dir, 33, g);
				}
				break;
			}
			case 112:
			...
			case 127:
			{
				...
				{
					fraImgEff.drawFrameNew(frame * 2 + f / 3 % 2, x, num37, 0, 3, g);
				}
				else
				{
					fraImgEff.drawFrameNew(frame * 2, x, num37, 0, 3, g);
				}
				break;
			}
			case 128:
			...
			case 126:
			{
				...
				{
					Point_Focus point_Focus3 = (Point_Focus)VecEff.elementAt(num32);
			...
			case 130:
				if (objTo != null)
				{
					...
					{
						Point point27 = (Point)VecEff.elementAt(num30);
						fraImgEff.drawFrameNew(point27.frame, objTo.x + point27.x, objTo.y + point27.y, 0, 33, g);
					}
				}
				break;
			case 131:
			...
			case 167:
			{
				...
				for (int num15 = 0; num15 < VecEff.size(); num15++)
				{
					...
					if (point19.frame == 1)
					{
						...
						if (typeEffect == 140)
						{
							fraImgEff.drawFrameNew(frame, point19.x, point19.y, 0, 33, g);
						}
						continue;
					}
					if (f > fRemove - 2)
					...
					fraImgSubEff.drawFrameNew(frame, point19.x + num17, point19.y + num18, 0, 33, g);
				}
				break;
			}
			case 146:
			{
				...
				{
					Point point18 = (Point)VecEff.elementAt(num13);
					fraImgEff.drawFrame(3 + point18.f % 3, point18.x / 1000, point18.y / 1000, Dir, 3, g);
				}
				break;
			}
			case 147:
			...
			case 153:
			{
				...
				for (int num11 = 0; num11 < VecEff.size(); num11++)
				{
					...
					if (CRes.random(2) == 0)
					{
						fraImgSub2Eff.drawFrameNew(CRes.random(4) + point17.frame * 4, point17.x, point17.y, Dir, 3, g);
					}
				}
				break;
			}
			...
			case 160:
			{
				for (int num4 = 0; num4 < VecEff.size(); num4++)
				{
					...
					if (!point11.isRemove)
					{
						fraImgEff.drawFrameNew(typeSub * fraImgEff.maxNumFrame + point11.frame, point11.x, point11.y, point11.dis, 3, g);
					}
				}
				break;
			}
			case 161:
			{
				...
				for (int n = 0; n < VecEff.size(); n++)
				{
					...
					fraImgEff.drawFrameNew(typeSub * fraImgEff.maxNumFrame + point7.frame, point7.x / 100, point7.y / 100, 0, 3, g);
				}
				break;
			}
			case 162:
	...
	public override void update()
	{
		...
		case 128:
			...
			mSystem.outz("vo day 1 typesub = " + typeSub);
			if (typeEffect == 128)
			{
				mSystem.outz("vo day 2 typesub = " + typeSub);
				if (typeSub > 20)
				{
		...
		case 6:
			if (typeSub == 3)
			{
				for (int l = 0; l < VecEff.size(); l++)
				{
					Point obj = (Point)VecEff.elementAt(l);
					obj.f++;
		...
		case 120:
		{
			for (int num52 = 0; num52 < VecEff.size(); num52++)
			{
				Point obj4 = (Point)VecEff.elementAt(num52);
				obj4.update();
				obj4.vy++;
			}
			if (f >= fRemove)
		...
		case 168:
		{
			for (int num55 = 0; num55 < VecEff.size(); num55++)
			{
				Point obj5 = (Point)VecEff.elementAt(num55);
				obj5.update();
				obj5.vy++;
			}
			if (f >= fRemove)
		...
		case 107:
		{
			for (int num44 = 0; num44 < VecEff.size(); num44++)
			{
				((Point)VecEff.elementAt(num44)).update();
			}
			if (f >= fRemove)
			{
				removeEff();
		...
		case 83:
		{
			...
			for (int num9 = 0; num9 < VecEff.size(); num9++)
			{
				...
				if ((point7.vy > 0 && point7.y >= 0) || (point7.vy < 0 && point7.y <= -30))
				{
					point7.vy = -point7.vy;
				}
				point7.y += point7.vy;
		...
		case 70:
		{
			for (int k = 0; k < VecEff.size(); k++)
			{
				...
				if ((point2.vy > 0 && point2.y >= 0) || (point2.vy < 0 && point2.y <= -30))
				{
					point2.vy = -point2.vy;
				}
				point2.y += point2.vy;
		...
		case 155:
		{
			for (int num45 = 0; num45 < VecEff.size(); num45++)
			{
				Point obj3 = (Point)VecEff.elementAt(num45);
		...
		case 78:
		{
			...
			if (typeSub != 1 && f < fRemove + 10)
			{
				...
				{
					Point point22 = new Point(x + CRes.random_Am_0(4), y + CRes.random_Am_0(4));
					point22.frame = CRes.random(3);
					point22.vy = -1 + CRes.random(3);
					point22.vx = CRes.random_Am_0(2);
					point22.fRe = 8 + CRes.random(4);
			...
			for (int num36 = 0; num36 < VecEff.size(); num36++)
			{
				...
				point23.update();
				point23.vy++;
				if (point23.f >= point23.fRe)
				{
					VecEff.removeElement(point23);
					num36--;
				}
			}
		...
		case 84:
		{
			for (int num23 = 0; num23 < VecEff.size(); num23++)
			{
				Point point14 = (Point)VecEff.elementAt(num23);
				point14.update();
				if (point14.f > point14.fRe)
				{
					if (point14.f - point14.fRe == 2)
					{
						point14.frame = 2;
					}
					if (point14.f - point14.fRe == 4)
					{
						point14.frame = 3;
					}
					if (point14.f - point14.fRe == 6)
					{
		...
		case 31:
		{
			...
			if (f < 10 && f % 3 == 2)
			{
				...
				{
					Point point33 = new Point(x + CRes.random_Am_0(20), y - CRes.random(30) + 10);
					point33.vy = -2 - CRes.random(4);
					point33.dis = 0;
					point33.frame = CRes.random(fraImgSubEff.nFrame);
					point33.fRe = CRes.random(12, 20);
		...
		case 32:
		{
			...
			if (f < fRemove && (f % 3 == 2 || f < 3))
			{
				...
				{
					Point point24 = new Point(x + CRes.random_Am_0(20), y + CRes.random(30) - 72);
					point24.vy = 2 + CRes.random(4);
					point24.dis = 0;
					point24.frame = CRes.random(fraImgSubEff.nFrame);
					point24.fRe = CRes.random(12, 20);
			...
			for (int num39 = 0; num39 < VecEff.size(); num39++)
			{
				Point point25 = (Point)VecEff.elementAt(num39);
				point25.update();
				if (point25.dis == 1)
				{
					point25.vy = vy;
		...
		case 33:
			if (f % 5 == 0)
			{
				...
				sbyte b = 0;
				b = 2;
				LoginScreen.addEffectEnd(25, b, objMainEff.x + num37, objMainEff.y - objMainEff.dy - objMainEff.hOne / 3 * 2 + 10, Dir, objMainEff);
			}
			if (f >= fRemove)
			{
				removeEff();
		...
		case 15:
		{
			...
			if (f == 5)
			{
				...
				LoginScreen.addEffectEnd(16, 1, x + num20, objMainEff.y - objFireMain.hOne / 2 - 10 + num19, Dir, objMainEff);
			}
			if (f == 10)
			{
				int num21 = 30;
				...
				LoginScreen.addEffectEnd(16, 2, x + num21, objFireMain.y - objFireMain.hOne / 2 + num19, Dir, objMainEff);
			}
			if (f == 15)
			{
				int num22 = 20;
				...
				LoginScreen.addEffectEnd(16, 1, x + num22, objFireMain.y - objFireMain.hOne / 2 - 10 + num19, Dir, objMainEff);
			}
			if (f >= fRemove)
			{
				removeEff();
		...
		case 44:
			if (f % 4 == 0)
			{
				...
				LoginScreen.addEffectEnd(35, 0, objFireMain.x + num12, objFireMain.y - objFireMain.dy - objFireMain.hOne / 3 * 2 + 10, Dir, objMainEff);
			}
			if (f >= fRemove)
			{
				removeEff();
		...
		case 93:
		{
			for (int num57 = 0; num57 < VecEff.size(); num57++)
			{
				Point point39 = (Point)VecEff.elementAt(num57);
				point39.update();
				point39.vy++;
		...
		case 96:
		{
			...
			for (int num50 = 0; num50 < VecEff.size(); num50++)
			{
				...
				{
					GameScreen.addEffectEnd(4, 0, point_Focus6.x - 20 + 20 * num51, point_Focus6.y - 20 + num51 % 2 * 20, Dir, objMainEff);
				}
			}
			VecEff.removeAllElements();
			removeEff();
		...
		case 104:
		{
			if (f == 3 || f == 6)
			{
				int num40 = CRes.random(4, 7);
				for (int num41 = 0; num41 < num40; num41++)
				{
					Point point26 = new Point(x + CRes.random_Am_0(20), y + CRes.random_Am_0(10));
		...
		case 111:
		{
			...
			if (f % 2 == 1)
			{
				...
				{
					Point point13 = new Point(CRes.random_Am_0(20), -5 + CRes.random(10));
					point13.vy = -CRes.random(12, 20);
					point13.frame = CRes.random(fraImgSubEff.nFrame);
		...
		case 113:
		{
			...
			if (f < 8)
			{
				...
				num3 = 360 / num4;
				int num6 = CRes.random(num3);
				for (int num7 = 0; num7 < num4; num7++)
				{
					Point point5 = new Point();
					point5.x = x * 1000 + CRes.getcos(CRes.fixangle(num6 + num3 * num7) + f * 5) * f * vMax;
					point5.y = y * 1000 + CRes.getsin(CRes.fixangle(num6 + num3 * num7) + f * 5) * f * (vMax - 4);
					point5.dis = f % 1;
					point5.fSmall = 1;
					if (typeSub == 2)
					{
			...
			for (int num8 = 0; num8 < VecEff.size(); num8++)
			{
				Point point6 = (Point)VecEff.elementAt(num8);
				point6.f++;
				if (point6.f == 1)
				{
					if (point6.dis == 0)
					{
						int tile = GameCanvas.loadmap.getTile(point6.x / 1000, point6.y / 1000);
						if (tile == 0 || tile == 2)
						{
							GameScreen.addEffectEnd(66, (point6.frame != 1) ? 1 : 0, point6.x / 1000, point6.y / 1000, Dir, objMainEff);
						}
						else
						{
					...
					if (CRes.random(6) == 0)
					{
						GameScreen.addEffectEnd(110, (point6.frame != 1) ? 1 : 0, point6.x / 1000, point6.y / 1000, Dir, objMainEff);
					}
				}
				if (point6.f / 3 >= fraImgSubEff.maxNumFrame || point6.isRemove)
				{
		...
		case 116:
		{
			...
			{
				Point point36 = (Point)VecEff.elementAt(num56);
				point36.update();
			...
			if (f % 5 == 1 && f < fRemove && CRes.random(2) == 0)
			{
				...
				point37.x = x + CRes.random_Am_0(10);
				point37.y = y + CRes.random(20);
				point37.vx = CRes.random_Am_0(3);
				point37.vy = -CRes.random(3, 7);
				point37.fRe = CRes.random(12, 18);
				VecEff.addElement(point37);
			}
			if (f % 4 == 1 && f < fRemove)
			{
				Point point38 = new Point();
				point38.x = x + CRes.random_Am_0(15);
				point38.y = y + CRes.random(20);
				point38.vx = CRes.random_Am_0(3);
				point38.vy = -CRes.random(3, 7);
				point38.fRe = CRes.random(4, 7);
		...
		case 119:
		{
			...
			{
				Point point29 = (Point)VecEff.elementAt(num46);
				point29.update();
				if (point29.f >= point29.fRe)
				{
					VecEff.removeElementAt(num46);
					num46--;
				}
			}
			if (f % 3 == 0 && f < fRemove)
			{
				...
				point30.fRe = mPlayFrame.Length;
				VecEff.addElement(point30);
			}
			if (f >= fRemove && VecEff.size() == 0)
			{
				removeEff();
		...
		case 130:
		{
			for (int num24 = 0; num24 < VecEff.size(); num24++)
			{
				...
				point15.x += point15.vx;
				point15.y += point15.vy;
				if (point15.y <= -60)
				{
					VecEff.removeElementAt(num24);
					num24--;
				}
			}
			if (f % 10 == 0)
			{
				for (int num25 = 0; num25 < 5; num25++)
				{
					...
					point16.x = CRes.random_Am_0(15);
					point16.y = 10 - CRes.random(40);
					point16.dis = 1 + CRes.random(3);
					point16.vy = -4;
					point16.frame = CRes.random(12);
		...
		case 137:
		{
			...
			{
				Point point12 = (Point)VecEff.elementAt(num16);
				point12.x += vx;
				point12.f++;
				if (point12.f >= point12.fRe)
				{
					VecEff.removeElementAt(num16);
					num16--;
				}
			}
			if (f >= fRemove)
		...
		case 167:
		{
			for (int num11 = 0; num11 < VecEff.size(); num11++)
			{
				Point point9 = (Point)VecEff.elementAt(num11);
				if (CRes.random(3) == 0)
				{
					point9.x = x + CRes.random_Am_0(3);
					point9.y = y + CRes.random_Am_0(3);
				}
			}
			if (f >= fRemove)
			{
		...
		case 146:
		{
			for (int num10 = 0; num10 < VecEff.size(); num10++)
			{
				((Point)VecEff.elementAt(num10)).update();
			}
			if (f >= fRemove)
			{
				removeEff();
		...
		case 153:
		{
			...
			for (int num53 = 0; num53 < VecEff.size(); num53++)
			{
				Point point34 = (Point)VecEff.elementAt(num53);
				point34.update();
				...
				{
					VecEff.removeElementAt(num53);
					num53--;
				}
			}
			if (f >= 140 && f <= 180)
			{
				for (int num54 = 0; num54 < MotherCanvas.w / 10 - 1; num54++)
				{
					if (CRes.random(4) == 0)
					{
						Point point35 = new Point(MainScreen.cameraMain.xCam + 5 + num54 * 10 + CRes.random(3), y);
						point35.vy = 5;
		...
		case 158:
		{
			...
			for (int num29 = 0; num29 < VecEff.size(); num29++)
			{
				...
				point20.update();
				if (point20.x < MainScreen.cameraMain.xCam)
				{
					point20.x += MotherCanvas.w;
				}
				else if (point20.x > MainScreen.cameraMain.xCam + MotherCanvas.w)
				{
					point20.x -= MotherCanvas.w;
				}
			...
			if (f >= 40 && f <= 90)
			{
				for (int num32 = 0; num32 < MotherCanvas.w / 10 - 1; num32++)
				{
					if (CRes.random(4) == 0)
					{
						Point point21 = new Point(MainScreen.cameraMain.xCam + 5 + num32 * 10 + CRes.random(3), MainScreen.cameraMain.yCam - 10);
						point21.vy = 5;
						point21.vx = CRes.random_Am_0(2);
						point21.fRe = MotherCanvas.h / 5 + CRes.random_Am_0(10);
						point21.frame = CRes.random(9);
		...
		case 160:
		{
			for (int num27 = 0; num27 < VecEff.size(); num27++)
			{
				...
				point18.x += point18.vx;
				point18.y += point18.vy;
				if (f < 6 || f > 12)
				{
					point18.vy = -1;
				}
				...
				if (f > 10)
				{
					if (num27 == 0 || num27 == VecEff.size() - 1)
					{
						point18.isRemove = true;
					}
					else
					{
		...
		case 161:
		{
			...
			{
				int num14 = 7 + CRes.random(3);
				for (int num15 = 0; num15 < num14; num15++)
				{
					Point point11 = new Point();
					point11.x = x * 100 + CRes.random_Am_0(200);
					point11.y = y * 100 + CRes.random_Am_0(200);
					point11.vx = CRes.random_Am_0(200);
					point11.vy = CRes.random_Am_0(200);
					point11.frame = 2 + CRes.random(2);
					point11.fRe = 6 + CRes.random(3);
