public class TabEquip : MainTab
{
	...
	public override void updatekey()
	{
		...
		if (flag)
		{
			...
			if (IdSelect == 8)
			{
				if ((MainItem)GameScreen.player.hashEquip.get(string.Empty + IdSelect) == null)
				{
					if ((MainItem)GameScreen.player.hashEquip.get(string.Empty + 9) == null)
					{
						IdSelect = idSelect;
						return;
					}
			...
			else if (IdSelect == 9 && (MainItem)GameScreen.player.hashEquip.get(string.Empty + IdSelect) == null)
			{
				if ((MainItem)GameScreen.player.hashEquip.get(string.Empty + 8) == null)
				{
					IdSelect = idSelect;
					return;
				}
	...
	public override void updatePointer()
	{
		if (GameCanvas.isPointSelect(xCurBegin, yCurBegin, wCur, hCur))
		{
			for (int i = 0; i < maxEquip; i++)
			{
				...
				if ((i == 8 || i == 9) && (MainItem)GameScreen.player.hashEquip.get(string.Empty + i) == null)
				{
