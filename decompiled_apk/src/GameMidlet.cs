...
public class GameMidlet
{
	...
	public static string IP = "160.250.131.76";

	public static int PORT = 2239;
	...
	public static string strLinkServerCheckENG = "http://fw.haitac.fun/service/thongbao.txt";
