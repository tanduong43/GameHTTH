public class QuickMenu : Menu
{
	...
	public void startAt()
	{
		...
		{
			if (mValueCmd[i][0] <= 5 || (mValueCmd[i][0] == 6 && Player.vecParty.size() > 0) || mValueCmd[i][0] == 16 || mValueCmd[i][0] == 7 || mValueCmd[i][0] == 8 || mValueCmd[i][0] == 9 || mValueCmd[i][0] == 12 || mValueCmd[i][0] == 11 || (mValueCmd[i][0] == 10 && GameScreen.player.clan != null) || mValueCmd[i][0] == 13 || mValueCmd[i][0] == 14 || mValueCmd[i][0] == 15)
			{
	...
	public override void commandPointer(int index, int subIndex)
	{
		...
		case 15:
			...
			break;
		case 16:
			GlobalService.gI().danhhieu(0, -1, 0);
			break;
		}
	}
