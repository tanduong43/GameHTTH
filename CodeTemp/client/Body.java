...
public class Body {
    ...
    private static int level = 32000;
...
//                if(p.my_pet.get(i).isUse == true){
//                    par += p.my_pet.get(i).template.option_pet.get(j).getParam();
//                    System.out.println("pararm = "+p.my_pet.get(i).template.option_pet.get(j).getParam());
//                }
//            }
//        }
        return par;
    ...
    public int get_total_point(int type) {
        ...
        switch (type) {
            case 1: {
                ...
                for (int i = 0; i < p.my_pet.size(); i++) {
                    for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                        List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                        if (op_pet.get(j).id == 5) {
                            if (p.my_pet.get(i).isUse == true) {
                                param += p.my_pet.get(i).template.option_pet.get(j).getParam();
                            }
                        }
                    }
                }
    ...
    public int get_dame(boolean have_eff) {
        ...
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 0) {
                    if (p.my_pet.get(i).isUse == true) {
                        dame += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
            }
        }
    ...
    public int get_def(boolean have_eff) {
        ...
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 3) {
                    if (p.my_pet.get(i).isUse == true) {
                        def += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
            }
        }
    ...
    public int get_hp_max(boolean have_eff) {
        ...
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 15) {
                    if (p.my_pet.get(i).isUse == true) {
                        hp += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
            }
        }
    ...
    public int get_mp_max(boolean have_eff) {
        ...
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 16) {
                    if (p.my_pet.get(i).isUse == true) {
                        mp += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
            }
        }
...
//        }
        ...
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 25) {
                    if (p.my_pet.get(i).isUse == true) {
                        agi += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
            }
        }
    ...
    public int get_multi_dame_decrease() {
        int par = total_param_item(69, false);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 69) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_mp_atk_absorb(boolean have_eff) {
        int par = total_param_item(22, have_eff);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 22) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_hp_atk_absorb(boolean have_eff) {
        int par = total_param_item(21, have_eff);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 21) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_hp_auto_buff(boolean have_eff) {
        int par = total_param_item(19, have_eff);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 19) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_mp_auto_buff(boolean have_eff) {
        int par = total_param_item(20, have_eff);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 20) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_dame_ap() {
        int par = total_param_item(2, true);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 2) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_percent_final_dame() {
        int par = total_param_item(46, true);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 46) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_xp_more() {
        int par = total_param_item(67, true);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 67) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_xp_skill_more() {
        int par = total_param_item(68, true);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 68) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_reduce_Eff() {
        int par = total_param_item(47, true);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 47) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_dame_skip_reduce() {
        int par = total_param_item(63, true);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 63) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_15(boolean have_eff) {
        int par = total_param_item(15, false);
        par += Body.Point3_Template_hp[this.get_total_point(3) - 1];
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 15) {
    ...
    public int get_16(boolean have_eff) {
        int par = total_param_item(16, false);
        par += Body.Point4_Template_mp[this.get_total_point(4) - 1];
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 16) {
    ...
    public int get_17(boolean have_eff) {
        int par = total_param_item(17, false);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 17) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
    ...
    public int get_18(boolean have_eff) {
        int par = total_param_item(18, false);
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 18) {
                    if (p.my_pet.get(i).isUse == true) {
                        par += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
...
//        }
    ...
    public int get_dame_percent_hp_target() {
        ...
        for (int i = 0; i < p.my_pet.size(); i++) {
            for (int j = 0; j < p.my_pet.get(i).template.option_pet.size(); j++) {
                List<Option> op_pet = p.my_pet.get(i).template.option_pet;
                if (op_pet.get(j).id == 48) {
                    if (p.my_pet.get(i).isUse == true) {
                        result += p.my_pet.get(i).template.option_pet.get(j).getParam();
                    }
                }
            }
        }
...
//        }
    ...
    public int get_miss_reduce() {
        ...
        public int get_netranh_cuoi() {
        int par = total_param_item(77, true);
        return par;
    } 
