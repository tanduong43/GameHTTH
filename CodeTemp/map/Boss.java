...
public class Boss {
    ...
    public static byte[] BOSS_LIVE = new byte[] {0, 0, 0, 0, 0, 0,0};
    public static byte[] BOSS_AREA = new byte[] {-1, -1, -1, -1, -1, -1,-1};
    ...
    public static void result_boss() {
        ...
        BOSS_LIVE = new byte[] {0, 0, 0, 0, 0, 0,0};
        BOSS_AREA = new byte[] {-1, -1, -1, -1, -1, -1,-1};
    }
}
