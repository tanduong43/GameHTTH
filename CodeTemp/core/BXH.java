...
public class BXH {
    ...
    public static List<InfoMemList> Dame_boss1 = new ArrayList<>();
    public static List<InfoMemList> Dame_boss2 = new ArrayList<>();
    public static List<InfoMemList> Dame_boss3 = new ArrayList<>();
    public static List<InfoMemList> Dame_boss4 = new ArrayList<>();
    public static List<InfoMemList> Dame_boss5 = new ArrayList<>();
    public static List<InfoMemList> Dame_boss6 = new ArrayList<>();
    ...
    public static void send(Player p, int type, int page) throws IOException {
        ...
        switch (type) {
            ...
            case 10: {
                int bound1 = 0;
                int bound2 = BXH.Dame_boss1.size();
                if (BXH.Dame_boss1.size() > 50) {
                    if (((page + 1) * 50) > BXH.Dame_boss1.size()) {
                        bound1 = 10 * page;
                        bound2 = BXH.Dame_boss1.size();
                        while (bound1 >= bound2) {
                            bound1 -= 50;
                            page--;
                        }
                ...
                m.writer().writeByte(4);
                m.writer().writeUTF("Dame_boss");
                m.writer().writeByte(page);
                m.writer().writeByte(bound2 - bound1);
                for (int i = bound1; i < bound2; i++) {
                    InfoMemList temp = BXH.Dame_boss1.get(i);
                    if ((temp.level >= 40 && temp.level <= 49)) {
                        InfoMemList.WriteInfoMemList(m.writer(), temp);
                    } else {
            ...
            case 11: {
                int bound1 = 0;
                int bound2 = BXH.Dame_boss2.size();
                if (BXH.Dame_boss2.size() > 50) {
                    if (((page + 1) * 50) > BXH.Dame_boss2.size()) {
                        bound1 = 10 * page;
                        bound2 = BXH.Dame_boss2.size();
                        while (bound1 >= bound2) {
                            bound1 -= 50;
                            page--;
                        }
                ...
                m.writer().writeByte(bound2 - bound1);
                for (int i = bound1; i < bound2; i++) {
                    InfoMemList temp = BXH.Dame_boss2.get(i);
                    if ((temp.level >= 50 && temp.level <= 59)) {
                        InfoMemList.WriteInfoMemList(m.writer(), temp);
                    } else {
            ...
            case 12: {
                int bound1 = 0;
                int bound2 = BXH.Dame_boss3.size();
                if (BXH.Dame_boss3.size() > 50) {
                    if (((page + 1) * 50) > BXH.Dame_boss3.size()) {
                        bound1 = 50 * page;
                        bound2 = BXH.Dame_boss3.size();
                        while (bound1 >= bound2) {
                            bound1 -= 50;
                            page--;
                        }
                ...
                m.writer().writeByte(bound2 - bound1);
                for (int i = bound1; i < bound2; i++) {
                    InfoMemList temp = BXH.Dame_boss3.get(i);
                    if ((temp.level >= 60 && temp.level <= 69)) {
                        InfoMemList.WriteInfoMemList(m.writer(), temp);
                    } else {
            ...
            case 13: {
                int bound1 = 0;
                int bound2 = BXH.Dame_boss4.size();
                if (BXH.Dame_boss4.size() > 50) {
                    if (((page + 1) * 50) > BXH.Dame_boss4.size()) {
                        bound1 = 50 * page;
                        bound2 = BXH.Dame_boss4.size();
                        while (bound1 >= bound2) {
                            bound1 -= 50;
                            page--;
                        }
                ...
                m.writer().writeByte(bound2 - bound1);
                for (int i = bound1; i < bound2; i++) {
                    InfoMemList temp = BXH.Dame_boss4.get(i);
                    if ((temp.level >= 70 && temp.level <= 79)) {
                        InfoMemList.WriteInfoMemList(m.writer(), temp);
                    } else {
            ...
            case 14: {
                int bound1 = 0;
                int bound2 = BXH.Dame_boss5.size();
                if (BXH.Dame_boss5.size() > 50) {
                    if (((page + 1) * 50) > BXH.Dame_boss5.size()) {
                        bound1 = 50 * page;
                        bound2 = BXH.Dame_boss5.size();
                        while (bound1 >= bound2) {
                            bound1 -= 50;
                            page--;
                        }
                ...
                m.writer().writeByte(bound2 - bound1);
                for (int i = bound1; i < bound2; i++) {
                    InfoMemList temp = BXH.Dame_boss5.get(i);
                    if ((temp.level >= 80 && temp.level <= 89)) {
                        InfoMemList.WriteInfoMemList(m.writer(), temp);
                    } else {
            ...
            case 15: {
                int bound1 = 0;
                int bound2 = BXH.Dame_boss6.size();
                if (BXH.Dame_boss6.size() > 50) {
                    if (((page + 1) * 50) > BXH.Dame_boss6.size()) {
                        bound1 = 50 * page;
                        bound2 = BXH.Dame_boss6.size();
                        while (bound1 >= bound2) {
                            bound1 -= 50;
                            page--;
                        }
                ...
                m.writer().writeByte(bound2 - bound1);
                for (int i = bound1; i < bound2; i++) {
                    InfoMemList temp = BXH.Dame_boss6.get(i);
                    if (temp.level > 90) {
                        InfoMemList.WriteInfoMemList(m.writer(), temp);
                    }else{
    ...
    private static void updateDame_boss1() {
        List<InfoMemList> list_add = new ArrayList<>();
        Connection connection = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            connection = SQL.gI().getCon();
            ps = connection.prepareStatement(
                    "SELECT `id`, `name`, `clazz`, `level`, `body`, `it_body`, `fashion`, `site`,`dame_1` FROM `players` ORDER BY `dame_1` DESC LIMIT 50;");
            rs = ps.executeQuery();
            while (rs.next()) {
                InfoMemList temp = new InfoMemList();
                temp.id = rs.getInt("id");
                ...
                long dame_boss = rs.getLong("dame_1");
                if (dame_boss > 1000) {
                    temp.info = dame_boss / 1000 + ".B";
                } else if(dame_boss > 1){
                    temp.info = dame_boss + ".Tr";
                }else{
                    temp.info = "Dame quá nhỏ";
                }
        ...
        if (list_add.size() > 0) {
            ...
            BXH.Dame_boss1.clear();
            BXH.Dame_boss1.addAll(list_add);
            list_add.clear();
        }
    }

    private static void updateDame_boss2() {
        List<InfoMemList> list_add = new ArrayList<>();
        Connection connection = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            connection = SQL.gI().getCon();
            ps = connection.prepareStatement(
                    "SELECT `id`, `name`, `clazz`, `level`, `body`, `it_body`, `fashion`, `site`,`dame_2` FROM `players` ORDER BY `dame_2` DESC LIMIT 50;");
            rs = ps.executeQuery();
            while (rs.next()) {
                InfoMemList temp = new InfoMemList();
                temp.id = rs.getInt("id");
                ...
                long dame_boss = rs.getLong("dame_2");
                if (dame_boss > 1000) {
                    temp.info = dame_boss / 1000 + ".B";
                } else if(dame_boss > 1){
                    temp.info = dame_boss + ".Tr";
        ...
        if (list_add.size() > 0) {
            ...
            BXH.Dame_boss2.clear();
            BXH.Dame_boss2.addAll(list_add);
            list_add.clear();
        }
    }

    private static void updateDame_boss3() {
        List<InfoMemList> list_add = new ArrayList<>();
        Connection connection = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            connection = SQL.gI().getCon();
            ps = connection.prepareStatement(
                    "SELECT `id`, `name`, `clazz`, `level`, `body`, `it_body`, `fashion`, `site`,`dame_3` FROM `players` ORDER BY `dame_3` DESC LIMIT 50;");
            rs = ps.executeQuery();
            while (rs.next()) {
                InfoMemList temp = new InfoMemList();
                temp.id = rs.getInt("id");
                ...
                long dame_boss = rs.getLong("dame_3");
                if (dame_boss > 1000) {
                    temp.info = dame_boss / 1000 + ".B";
                } else if(dame_boss > 1){
                    temp.info = dame_boss + ".Tr";
        ...
        if (list_add.size() > 0) {
            ...
            BXH.Dame_boss3.clear();
            BXH.Dame_boss3.addAll(list_add);
            list_add.clear();
        }
    }

    private static void updateDame_boss4() {
        List<InfoMemList> list_add = new ArrayList<>();
        Connection connection = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            connection = SQL.gI().getCon();
            ps = connection.prepareStatement(
                    "SELECT `id`, `name`, `clazz`, `level`, `body`, `it_body`, `fashion`, `site`,`dame_4` FROM `players` ORDER BY `dame_4` DESC LIMIT 50;");
            rs = ps.executeQuery();
            while (rs.next()) {
                InfoMemList temp = new InfoMemList();
                temp.id = rs.getInt("id");
                ...
                long dame_boss = rs.getLong("dame_4");
                if (dame_boss > 1000) {
                    temp.info = dame_boss / 1000 + ".B";
                } else if(dame_boss > 1){
                    temp.info = dame_boss + ".Tr";
        ...
        if (list_add.size() > 0) {
            ...
            BXH.Dame_boss4.clear();
            BXH.Dame_boss4.addAll(list_add);
            list_add.clear();
        }
    }

    private static void updateDame_boss5() {
        List<InfoMemList> list_add = new ArrayList<>();
        Connection connection = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            connection = SQL.gI().getCon();
            ps = connection.prepareStatement(
                    "SELECT `id`, `name`, `clazz`, `level`, `body`, `it_body`, `fashion`, `site`,`dame_5` FROM `players` ORDER BY `dame_5` DESC LIMIT 50;");
            rs = ps.executeQuery();
            while (rs.next()) {
                InfoMemList temp = new InfoMemList();
                temp.id = rs.getInt("id");
                ...
                long dame_boss = rs.getLong("dame_5");
                if (dame_boss > 1000) {
                    temp.info = dame_boss / 1000 + ".B";
                } else if(dame_boss > 1){
                    temp.info = dame_boss + ".Tr";
        ...
        if (list_add.size() > 0) {
            ...
            BXH.Dame_boss5.clear();
            BXH.Dame_boss5.addAll(list_add);
            list_add.clear();
        }
    }

    private static void updateDame_boss6() {
        List<InfoMemList> list_add = new ArrayList<>();
        Connection connection = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            connection = SQL.gI().getCon();
            ps = connection.prepareStatement(
                    "SELECT `id`, `name`, `clazz`, `level`, `body`, `it_body`, `fashion`, `site`,`dame_6` FROM `players` ORDER BY `dame_6` DESC LIMIT 50;");
            rs = ps.executeQuery();
            while (rs.next()) {
                InfoMemList temp = new InfoMemList();
                temp.id = rs.getInt("id");
                ...
                long dame_boss = rs.getLong("dame_6");
                if (dame_boss > 1000) {
                    temp.info = dame_boss / 1000 + ".B";
                } else if(dame_boss > 1){
                    temp.info = dame_boss + ".Tr";
        ...
        if (list_add.size() > 0) {
            ...
            BXH.Dame_boss6.clear();
            BXH.Dame_boss6.addAll(list_add);
            list_add.clear();
        }
    }
