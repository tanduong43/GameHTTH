...
//                            }
                ...
                case -1: {
                    if (p.conn.status != 1) {
                        send_dynamic_menu(
                            ...
                            "Cao thủ", "Băng hải tặc", "Truy nã", "Đá hành trình", "Điểm Danh", "Điểm Danh Vip" + p.conn.vip, "SUPER BOSS"},
                                null);
                    } else {
                        send_dynamic_menu(p, type, get_name_npc(type), new String[]{"Thách đấu", "Cao thủ",
                            "Băng hải tặc", "Truy nã", "Đá hành trình", "Điểm Danh", "Điểm Danh Vip " + p.conn.vip, "Super Boss"}, null);
                    }
                    break;
                }
                case -133: {
                    send_dynamic_menu(p, type, "Kho Báu",
                            new String[]{"Vòng quay kho báu", "Hoàn mỹ - Kích ẩn", "Vòng quay ốc sên", "Lục Thức", "Sức Mạnh Vật Lý", "Doriki", "Vòng quay Wc"}, null);
                    break;
                }
                case -105:
                case -90:
        ...
        if (!p.isdie) {
            ...
            switch (idNPC) {
                    ...
                    switch (index) {
                        case 0: {
                            if (p.conn.coin < 10000) {
                                Service.send_box_ThongBao_OK(p, "Bạn Không đủ 20000 Coin để kích hoạt!");
                                return;
                            }
                            if (p.mocnap1 == 0) {
                                p.mocnap1 = 1;
                                int ruby = 200000;
                                int beri = 1000000;
                                boolean item1 = p.item.add_item_bag47(4, 160, 1);
                                p.update_coin(-20000);
                                p.update_ngoc(ruby);
                                p.update_vang(beri);

                                p.update_money();
                                Service.send_box_ThongBao_OK(p, "Bạn đã nhận được quà mốc 1");
                            } else {
                                Service.send_box_ThongBao_OK(p, "Bạn đã nhận quà rồi");
                            }
                            break;
                        }
                        case 1: {
                            if (p.conn.coin < 20000) {
                                Service.send_box_ThongBao_OK(p, "Bạn Không đủ 20000 Coin để kích hoạt!");
                                return;
                            }
                            if (p.mocnap1 == 0) {
                    ...
                    if (index == 0) {
                        ...
                        for (int i = 0; i < ShopTichLuy.ENTRY.size(); i++) {
                            ...
                            switch (temp.type) {
                                ...
                                case 0: { // thoi trang
                                    DanhHieu temp0 = DanhHieu.get_Id(temp.id);
                                    m.writer().writeUTF(temp0.Name);
                                    m.writer().writeShort(temp0.idicon);
                                    break;
                                }
                            }
                            String info = temp.info + "\n" + Util.number_format((temp.point * 1000)) + " Coin.";
                            if (temp.limit > 0) {
                                int time = 0;
                ...
                case -48: {
                    ...
                    switch (index) {
                        case 0: {
                            if (p.moc5m == 0 && p.conn.status >= 1) 
                            {
                                p.id_danh_hieu_da_so_huu.add(2);
                                Service.send_box_ThongBao_OK(p, "Bạn Đã Nhận Danh Hiệu Thành Viên");
                                p.moc5m = 1;
                            } else if (p.moc5m > 0) {
                                Service.send_box_ThongBao_OK(p, "Bạn đã Nhận Quà rồi");
                            } else if (p.conn.status < 1) {
                                Service.send_box_ThongBao_OK(p, "Bạn chưa Mở Thành Viên ,Hãy nạp ủng hộ mình duy trì game nhé!!");
                            }

                            break;
                        }
                           case 1: {
                            if (p.moc50k == 0 && p.conn.status >= 1) {
                                p.moc50k = 1;
                                List<GiftBox> list_gift = new ArrayList<>();
                                ItemTemplate4 it_temp4;
                                GiftBox gb_beri = new GiftBox();
                                it_temp4 = ItemTemplate4.get_it_by_id(0);//beri
                                if (it_temp4 != null) {
                                    gb_beri.id = it_temp4.id;
                                    gb_beri.type = 4;
                                    gb_beri.name = it_temp4.name;
                                    gb_beri.icon = it_temp4.icon;
                                    gb_beri.num = beri * 7;//nhân 11
                                    gb_beri.color = 0;
                                    list_gift.add(gb_beri);
                                }
                                //
                                GiftBox gb_beri2 = new GiftBox();
                                it_temp4 = ItemTemplate4.get_it_by_id(1);//ruby
                                if (it_temp4 != null) {
                                    gb_beri2.id = it_temp4.id;
                                    gb_beri2.type = 4;
                                    gb_beri2.name = it_temp4.name;
                                    gb_beri2.icon = it_temp4.icon;
                                    gb_beri2.num = 5000;//nhân 11
                                    gb_beri2.color = 0;
                                    list_gift.add(gb_beri2);
                                }
                                GiftBox gb_beri3 = new GiftBox();
                                it_temp4 = ItemTemplate4.get_it_by_id(158);
                                if (it_temp4 != null) {
                                    gb_beri3.id = it_temp4.id;
                                    gb_beri3.type = 4;
                                    gb_beri3.name = it_temp4.name;
                                    gb_beri3.icon = it_temp4.icon;
                                    gb_beri3.num = 5;
                                    gb_beri3.color = 0;
                                    list_gift.add(gb_beri3);
                                    ItemFashion itf = ItemFashion.get_item(45);
                                ...
                                GiftBox gb_beri6 = new GiftBox();
                                it_temp4 = ItemTemplate4.get_it_by_id(159);
                                if (it_temp4 != null) {
                                    gb_beri6.id = it_temp4.id;
                                    gb_beri6.type = 4;
                                    gb_beri6.name = it_temp4.name;
                                    gb_beri6.icon = it_temp4.icon;
                                    gb_beri6.num = 35;
                                    gb_beri6.color = 0;
                                    list_gift.add(gb_beri6);
                                }
                                ...
                                Service.send_gift(p, 0, "Quà Mở Thành Viên", "Phần thưởng", list_gift, true);
                                p.moc50k = 1;
                            } else if (p.moc50k > 0) {
                                Service.send_box_ThongBao_OK(p, "Bạn đã nạp mốc này rồi");
                            } else if (p.conn.status < 1) {
                                Service.send_box_ThongBao_OK(p, "Bạn chưa Mở Thành Viên ,Hãy nạp ủng hộ mình duy trì game nhé!!");
                            }
                            break;
              ...
              break;
                        ...
                        case 2: {
                            Service.send_box_ThongBao_OK(p, "Đang bảo trì, anh em lên web hoặc ib admin để nạp nha");
                            break;
                        }
                        case 3: {
                ...
                case 999: {
                    Service.send_box_yesno(p, 64, "Thông báo",
                            "Bạn có muốn đổi lấy danh hiệu " + DanhHieu.ENY.get(index).Name + " với giá " + DanhHieu.ENY.get(index).coint + " coin",
                            new String[]{"Đồng ý", "Hủy"}, new byte[]{-1, -1});
                    p.id_danh_hieu_doi = index;
                    break;
                }
                case 997: {
    ...
    private static void Menu_LucThuc(Player p, byte index) throws IOException {
        switch (index) {
            ...
            case 1: {
                if (p.level >= 110 && p.doriki[0] >= 8 && p.sucmanhvatly == 15) {
                    LucThuc.start(p);
                } else {
                ...
                if (p.id_ship_packet != -1 && p.ship_pet != null
                    ...
                    if (p.id_ship_packet != -1) {
                        ...
                        if (p.typePirate == 2) {
                            ...
                            ruby_total = (ruby_total * 3) / 10;
                        }
                        p.update_vang(beri_total);
                        p.update_ngoc(ruby_total);
                        ...
                        if (!name_BaoVe.isEmpty()) {
                            ...
                            if (p0 != null && p0.name_ThoSanHaiTac.length == 1
                                ...
                                //
                                p.update_vang(-beri_total);
                                p0.update_ngoc(ruby_total);
                                //
                                p.update_ngoc(-ruby_total);
                                p.tieu_ruby += ruby_total;
                                //

                                p0.update_money();

                                Service.send_box_ThongBao_OK(p0,
                                        "Bảo vệ hàng thành công nhận " + beri_total + " beri và" + ruby_total + "ruby");
                                p0.name_ThoSanHaiTac = null;
                                Service.send_box_ThongBao_OK(p, "Trả hàng thành công nhận " + beri_total + " beri và" + ruby_total + "ruby");
                            } else {
                                Service.send_box_ThongBao_OK(p, "Trả hàng thành công nhận " + beri_total + " beri và" + ruby_total + "ruby");
                            }
                        } else {
    ...
    private static void menu_sanTrum(Player p, byte index) throws IOException {
        switch (index) {
            case 0: {
                Vgo vgo = new Vgo();
                vgo.map_go = Map.get_map_by_id(201);
            ...
            case 1: {
                ...
                Vgo vgo = new Vgo();
                vgo.map_go = Map.get_map_by_id(202);
                vgo.xnew = (short) Util.random(120, 380);
                vgo.ynew = (short) Util.random(230, 330);
                p.goto_map(vgo);
                break;
    ...
    private static void Menu_Noel(Player p, byte index) throws IOException {
        switch (index) {
            case 0: {
                if (p.conn.status != 1) {
                    Service.send_box_ThongBao_OK(p, "Chưa kích hoạt không thể đổi");
                    return;
                }
                ...
                send_dynamic_menu(p, 999, "Danh hiệu", tx);
                break;
            }

            case 1: {
                List_tich_tieu.showTable(p);

                break;
            }
            case 2: {

                send_dynamic_menu(p, 987, "Shop ", new String[]{"Vào cửa hàng"}, null);
                break;
            }
            case 3: {
                send_dynamic_menu(p, 3214, "Nhận Quà", new String[]{"Nhận Danh Hiệu","Quà Mtv"}, null);
                break;
            }
            case 4: {

                Vgo vgo = new Vgo();
                vgo.map_go = Map.get_map_by_id(210);
                if (vgo.map_go != null) {
                    boolean full = false;
                    if (!full) {
    ...
    private static void Menu_Manu(Player p, byte index) throws IOException {
        switch (index) {
            case 0: {
    ...
    private static void Menu_Nami(Player p, byte index) throws IOException {
        switch (index) {
            ...
            case 1: {
                send_dynamic_menu(p, 3214, "Nhận Quà", new String[]{"Nhận Quà"}, null);
                break;
            }
            case 2: {
                Mission.showTable(p);
    ...
    private static void Menu_Zosaku(Player p, byte index) throws IOException {
        switch (index) {
            case 0: {
                send_dynamic_menu(p, 2001, "Săn Trùm", new String[]{"Trùm Cao Thủ"}, null);
                break;
            }
            case 2: { // pho ban lien tang
                if (index == 2) {
                    if (p.party == null || p.party.list.size() < 2
                            || !p.party.list.get(0).name.equals(p.name)) {
                        Service.send_box_ThongBao_OK(p, "Hãy tạo nhóm từ 2 người trở lên để vào phó bản");
                        return;
                    }
                    if (p.tableTickOption == null) {
            ...
            case 3: {
                ...
                } else if (p.map.template.id == 41) { // vuon cam
                    Map map_select = VuonCam.get_map(p);
                    if (map_select != null) {
                        Vgo vgo = new Vgo();
                        vgo.map_go = new Map[]{map_select};
                        vgo.xnew = 469;
                        vgo.ynew = 210;
                        p.goto_map(vgo);
                    } else {
                        if (!Manager.gI().server_admin && (p.party == null || p.party.list.size() < 2
                                || !p.party.list.get(0).name.equals(p.name))) {
                            Service.send_box_ThongBao_OK(p, "Hãy tạo nhóm với người khác trước khi vào phó bản");
                            return;
                        }
                        // p.party = new Party(p);
                        Service.send_box_yesno(p, 65, "Thông báo",
...
//        }
            ...
            case 8: {
                send_dynamic_menu(p, 9912, "Sieu Trum",
                        new String[]{"Check Boss", "BXH Siêu Boss", "Thông tin"}, null);
                break;
            }
        }
    }
    ...
    private static void Menu_Machiko(Player p, byte index) throws IOException {
        switch (index) {
            ...
            case 6: {
                Service.send_box_yesno(p, 778, "Thông báo",
                        "Đổi 999 Mảnh TT Franky lịch lãm và sao 8 cánh lấy thời trang Franky ?\n Tỉ lệ đổi thành công 30%",
                        new String[]{"Đồng ý", "Hủy"}, new byte[]{2, 1});
                break;
            }
        }
    ...
    private static void Menu_TAQ(Player p, byte index) throws IOException {
        switch (index) {
            case 0: {
                List<GiftBox> list_gift = new ArrayList<>();
                ItemTemplate4 it_temp4;
                GiftBox gb_beri = new GiftBox();
                it_temp4 = ItemTemplate4.get_it_by_id(160);//bẻi
                if (it_temp4 != null) {
                    gb_beri.id = it_temp4.id;
                    gb_beri.type = 4;
                    gb_beri.name = it_temp4.name;
                    gb_beri.icon = it_temp4.icon;
                    gb_beri.num = 1;//nhân 2
                    gb_beri.color = 0;
                    list_gift.add(gb_beri);
                }
                Service.send_gift(p, 0, "Trái ác quỷ cao", "Phần thưởng", list_gift, true);
                break;
            }
            case 1: {
                List<GiftBox> list_gift = new ArrayList<>();
                ItemTemplate4 it_temp4;
                GiftBox gb_beri = new GiftBox();
                it_temp4 = ItemTemplate4.get_it_by_id(161);//bẻi
                if (it_temp4 != null) {
                    gb_beri.id = it_temp4.id;
                    gb_beri.type = 4;
                    gb_beri.name = it_temp4.name;
            ...
            case 2: {
                ...
                ItemTemplate4 it_temp4;
                GiftBox gb_beri = new GiftBox();
                it_temp4 = ItemTemplate4.get_it_by_id(240);//bẻi
                if (it_temp4 != null) {
                    gb_beri.id = it_temp4.id;
                    gb_beri.type = 4;
                    gb_beri.name = it_temp4.name;
    ...
    private static void Menu_DO(Player p, byte index) throws IOException {
        switch (index) {
            case 0: {
                List<GiftBox> list_gift = new ArrayList<>();
                ItemTemplate3 it_temp3;
                GiftBox gb_beri = new GiftBox();
                it_temp3 = ItemTemplate3.get_it_by_id(12017);//bẻi
                if (it_temp3 != null) {
                    gb_beri.id = it_temp3.id;
                    gb_beri.type = 3;
                    gb_beri.name = it_temp3.name;
                    gb_beri.icon = it_temp3.icon;
                    gb_beri.num = 1;//nhân 2
                    gb_beri.color = 0;
                    list_gift.add(gb_beri);
                }
                Service.send_gift(p, 0, "Đồ Vip", "Phần thưởng", list_gift, true);
                break;
            }
            case 1: {
                List<GiftBox> list_gift = new ArrayList<>();
                ItemTemplate3 it_temp3;
                GiftBox gb_beri = new GiftBox();
                it_temp3 = ItemTemplate3.get_it_by_id(12018);//bẻi
                if (it_temp3 != null) {
                    gb_beri.id = it_temp3.id;
                    gb_beri.type = 3;
                    gb_beri.name = it_temp3.name;
            ...
            case 2: {
                ...
                ItemTemplate3 it_temp3;
                GiftBox gb_beri = new GiftBox();
                it_temp3 = ItemTemplate3.get_it_by_id(12019);//bẻi
                if (it_temp3 != null) {
                    gb_beri.id = it_temp3.id;
                    gb_beri.type = 3;
                    gb_beri.name = it_temp3.name;
            ...
            case 3: {
                ...
                ItemTemplate3 it_temp3;
                GiftBox gb_beri = new GiftBox();
                it_temp3 = ItemTemplate3.get_it_by_id(12020);//bẻi
                if (it_temp3 != null) {
                    gb_beri.id = it_temp3.id;
                    gb_beri.type = 3;
                    gb_beri.name = it_temp3.name;
            ...
            case 4: {
                ...
                ItemTemplate3 it_temp3;
                GiftBox gb_beri = new GiftBox();
                it_temp3 = ItemTemplate3.get_it_by_id(12021);//bẻi
                if (it_temp3 != null) {
                    gb_beri.id = it_temp3.id;
                    gb_beri.type = 3;
                    gb_beri.name = it_temp3.name;
            ...
            case 5: {
                ...
                ItemTemplate3 it_temp3;
                GiftBox gb_beri = new GiftBox();
                it_temp3 = ItemTemplate3.get_it_by_id(12022);//bẻi
                if (it_temp3 != null) {
                    gb_beri.id = it_temp3.id;
                    gb_beri.type = 3;
                    gb_beri.name = it_temp3.name;
            ...
            case 6: {
                ...
                ItemTemplate3 it_temp3;
                GiftBox gb_beri = new GiftBox();
                it_temp3 = ItemTemplate3.get_it_by_id(12023);//bẻi
                if (it_temp3 != null) {
                    gb_beri.id = it_temp3.id;
                    gb_beri.type = 3;
                    gb_beri.name = it_temp3.name;
            ...
            case 7: {
                ...
                ItemTemplate3 it_temp3;
                GiftBox gb_beri = new GiftBox();
                it_temp3 = ItemTemplate3.get_it_by_id(12024);//bẻi
                if (it_temp3 != null) {
                    gb_beri.id = it_temp3.id;
                    gb_beri.type = 3;
                    gb_beri.name = it_temp3.name;
        ...
        switch (index) {
            ...
            case 1: {
                ...
                send_dynamic_menu(p, 9988, "BXH Siêu trùm",
                        new String[]{"Siêu Along", "Siêu Smoker", "Siêu Mr. 3", "Siêu Wapol", "Siêu Crocodile", "Siêu Thần Enel"}, null);
                break;
            }
            case 2: {
                Service.send_box_ThongBao_OK(p, "Sát thương tính điểm siêu boss được tính dựa trên số dame bạn gây ra(Tối thiểu 1tr dame)");
                break;
            }
        }
    }
    ...
    private static void send_dynamic_menu(Player p, int idNPC, String title, List<String> name)
            throws IOException {
        if (!p.isdie) {
            Message m = new Message(-20);
            m.writer().writeByte(4);
            ...
            m.writer().writeByte(0);
            m.writer().writeUTF(title);
            m.writer().writeByte(name.size());
            for (int i = 0; i < name.size(); i++) {
                m.writer().writeUTF(name.get(i));
                m.writer().writeShort(-1);
            }
            p.conn.addmsg(m);
            m.cleanup();
