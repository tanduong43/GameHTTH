...
public class GiftBox {
    ...
    public static List<GiftBox> get_gift_map_boss_by_level(Player p) {
        ...
        if (35 > Util.random(120)) { // da hanh trinh
            ...
            if(p.map.template.id == 201 ||p.map.template.id == 202||p.map.template.id == 210){
            ItemTemplate4 itemTemplate4 = ItemTemplate4.get_it_by_id(159);
            GiftBox giftBox = new GiftBox();
            giftBox.id = (short) 159;
            giftBox.type = 4;
            giftBox.name = itemTemplate4.name;
            giftBox.icon = itemTemplate4.icon;
            giftBox.num = 5;
      ...
      if(p.map.template.id == 201 ||p.map.template.id == 202||p.map.template.id == 210){
            ItemTemplate7 itemTemplate7 = ItemTemplate7.get_it_by_id(6);
            GiftBox giftBox = new GiftBox();
            giftBox.id = (short) 6;
            giftBox.type = 4;
        ...
        if(p.map.template.id == 202){
            ItemTemplate7 itemTemplate7 = ItemTemplate7.get_it_by_id(5);
            GiftBox giftBox = new GiftBox();
            giftBox.id = (short) 21;
            giftBox.type = 4;
            giftBox.name = itemTemplate7.name;
      ...
      if(p.map.template.id == 202){
            ItemTemplate4 itemTemplate4 = ItemTemplate4.get_it_by_id(131);
            GiftBox giftBox = new GiftBox();
            giftBox.id = (short) 131;
            giftBox.type = 4;
            giftBox.name = itemTemplate4.name;
            giftBox.icon = itemTemplate4.icon;
            giftBox.num = 5;
